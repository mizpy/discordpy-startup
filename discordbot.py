...
ment_begin_prev_30min_datetime = ment_begin_datetime - datetime.datetime(minute=30)
ment_begin_prev_60min_datetime = ment_begin_datetime - datetime.datetime(minute=60)
ment_begin_prev_120min_datetime = ment_begin_datetime - datetime.datetime(minute=120)
ment_begin_prev_240min_datetime = ment_begin_datetime - datetime.datetime(minute=240)
